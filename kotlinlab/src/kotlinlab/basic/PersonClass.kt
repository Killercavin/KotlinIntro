...
fun students() {
    val student = _root_ide_package_.kotlinlab.basic.Person(
        name = "John",
        age = 20,
        gender = "male"
    )
...
fun cars() {
    val car = _root_ide_package_.kotlinlab.basic.Vehicle(
        name = "Tesla",
        model = "S Plaid",
        color = "Maroon"
    )
...
fun main(){
    // instance of class
    _root_ide_package_.kotlinlab.basic.students()
    _root_ide_package_.kotlinlab.basic.cars()
