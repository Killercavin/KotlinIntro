...
fun main(){
    ...
    _root_ide_package_.kotlinlab.basic.circleArea(radius)

    println("The area of the circle is ${_root_ide_package_.kotlinlab.basic.circleArea(radius)} square units")

    val combinedChar = _root_ide_package_.kotlinlab.basic.stringInterpolation()
