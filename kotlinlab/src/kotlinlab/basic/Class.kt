...
fun main(){
    val car0 = _root_ide_package_.kotlinlab.basic.Car() // instance of class car
    car0.color = "Red"
    car0.model = "BMW"
    ...
    val car1 = _root_ide_package_.kotlinlab.basic.Car()
    car1.color = "Blue"
    car1.model = "Ford"
    ...
    // another instance of car
    val car2 = _root_ide_package_.kotlinlab.basic.Car()
    car2.color = "White"
    car2.model = "Audi"
    ...
    // another instance of car
    val car3 = _root_ide_package_.kotlinlab.basic.Car()
    car3.color = "Black"
    ...
    val car4 = _root_ide_package_.kotlinlab.basic.Car()
    car4.color = "Green"
    car4.model = "Tesla"
