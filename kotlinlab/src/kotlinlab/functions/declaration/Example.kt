...
fun main() {
    val sum0 =
        _root_ide_package_.kotlinlab.functions.declaration.sum(3, 4) // assign the function to a variable and call it
    println(sum0) // output the final result from the function

    // say greeting
    println(_root_ide_package_.kotlinlab.functions.declaration.sayGreeting())

    // function with no return type
    println(_root_ide_package_.kotlinlab.functions.declaration.funWithoutReturnType())
}
