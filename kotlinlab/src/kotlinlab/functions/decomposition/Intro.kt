...
fun checkAction() {
    ...
    if (_root_ide_package_.kotlinlab.functions.decomposition.checkPassword(readln())) {
        // do some actions ie
        _root_ide_package_.kotlinlab.functions.decomposition.checkMusic(readln()) // check if the music is on
        _root_ide_package_.kotlinlab.functions.decomposition.checkDoor(readln()) // check if the door is open or closed
    }
}

fun main() {
    println(_root_ide_package_.kotlinlab.functions.decomposition.checkAction())
}
