...
fun factorialRecursive(n: Int): Int = if (n == 0 || n == 1) 1 else n * _root_ide_package_.kotlinlab.functions.recursion.factorialRecursive(
    n - 1
)
...
fun weirdFactorialRecursive(n: Int): Int = if (n == 0 || n == 1) 1 else _root_ide_package_.kotlinlab.functions.recursion.factorialCompute(
    n
)

fun factorialCompute(n: Int): Int = n * _root_ide_package_.kotlinlab.functions.recursion.weirdFactorialRecursive(n - 1)
...
fun tailFactorialRecursive(n: Int, cur: Int = 1): Int {
    if (n == 0) return cur
    return _root_ide_package_.kotlinlab.functions.recursion.tailFactorialRecursive(n - 1, cur * n)
}
...
fun fibonacci(n: Int): Int {
    if (n <= 0) return 0
    if (n == 1) return 1
    return _root_ide_package_.kotlinlab.functions.recursion.fibonacci(n - 1) + _root_ide_package_.kotlinlab.functions.recursion.fibonacci(
        n - 2
    )
}