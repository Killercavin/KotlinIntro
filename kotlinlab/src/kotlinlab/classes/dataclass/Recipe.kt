...
fun main() {
    val r1 = _root_ide_package_.kotlinlab.classes.dataclass.Recipe("Thai Curry", false)
    val r2 = _root_ide_package_.kotlinlab.classes.dataclass.Recipe("Chicken Bhuna", false)
